...
import { isElement, } from './common.js';
import { asciiWhitespace, htmlNamespace, xmlNamespace, } from './whatwg-infra.js';
// § 3.2.6.2 The lang and xml:lang attributes
// https://html.spec.whatwg.org/multipage/dom.html#language
export function languageOf(node) {
...
export function getPragmaSetDefaultLanguage() {
    ...
    let pragmaSetDefaultLanguage = undefined;
...
export function serializesAsVoid(element) {
...
export function isBeingRendered(element) {
