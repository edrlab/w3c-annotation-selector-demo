 ...
 * @public
 */
export function highlightText(target, tagName = 'mark', attributes = {}) {
...
function textNodesInRange(range) {
    ...
    const walker = ownerDocument(range).createTreeWalker(range.commonAncestorContainer, NodeFilter.SHOW_TEXT, {
